...
<body>
	...
	<div class="container">
        <div class="row">
            <div class="col text-center">
			<b>Enter a patient's OHIP number to record a vaccination. If the patient is not in the database, you will be prompted to add them.</b>
			<br>
			<br>
			<form action="insertRecord.php" method="post">
			<label for="fname">OHIP Number:</label><br>
